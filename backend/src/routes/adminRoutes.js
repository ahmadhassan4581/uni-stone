...
const { listContacts, updateContact, deleteContact, sendContactEmailAdmin } = require('../controllers/contactController')
const { listAllOrders, getOrder, updateOrderStatus } = require('../controllers/orderController')
const { listConsultations, updateConsultation, sendConsultationEmailAdmin } = require('../controllers/consultationController')
...
router.post('/contacts/:id/email', sendContactEmailAdmin)
...
router.post('/consultations/:id/email', sendConsultationEmailAdmin)
