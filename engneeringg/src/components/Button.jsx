...
export default function Button({
  ...
  const allBlue =
    'border-blue-600 bg-blue-600 text-white shadow-sm hover:border-blue-700 hover:bg-blue-700 focus-visible:ring-blue-500/60'
  const allGreen =
    'border-green-600 bg-green-600 text-white shadow-sm hover:border-green-700 hover:bg-green-700 focus-visible:ring-green-500/60'
